...
import Exercise from './components/Exercises/Exercise'; // <-- Import the new Exercise component
import './App.css';
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/parent/exercise" element={<Exercise />} /> {/* <-- New route for the Exercise component */}
